...
internal static class ReverseProxyConfigurations
{
    ...
    public const string UserNameHeaderName = "X-User-Name";
    public const string UserRoleIdHeaderName = "X-User-Role";
    public const string UserIpAddressHeaderName = "X-User-Ip";
